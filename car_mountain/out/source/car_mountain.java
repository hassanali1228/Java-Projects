...
public class car_mountain extends PApplet {
...
int darkBlue = 0xffFFCDA8;
int darkGrey = 0xff525355;
int darkGrey2 = 0xff53575F;
int lightGrey = 0xffEDF2FF; 
int lightGrey2 = 0xffE1E5F2;
...
public void draw(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "car_mountain" };
    if (passedArgs != null) {
